  ...
  return (
    ...
    <div className="flex items-center w-full h-full bg-cover bg-center" style={{backgroundImage: "url(/main-bg.webp)"}}>
          <div className="pl-20 md:pl-40 pb-56 md:pb-20 flex-col gap-5 z-[10] max-w-[750px]">
            ...
            Empowering skilled students to make anything possible in the world of technology through innovative freelance opportunities in data science, cybersecurity, and software development.
            </p>
            <div className="flex-col md:flex-row hidden md:flex gap-5">
              ...
              <Link href="/my-services" className="rounded-[20px] group relative bg-transparent px-5 border border-white py-3 text-lg text-white max-w-[200px]">
    ...
    <div className="absolute flex bottom-10 z-[20] right-5 flex-col md:hidden gap-5">
              ...
              <Link href="/my-services" className="rounded-[20px] group bg-transparent border border-white px-5 py-3 text-lg text-white max-w-[200px]">
                Our Services
              </Link>
